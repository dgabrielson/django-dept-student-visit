...
def resolve_fields(object, field_list, formatters=None):
    ...
    return (_resolve_lookup(object, field, formatters.get(field, None))
...
def object_with_fields(object, formatters, fields=None):
    ...
    lines = [
        "{0}\t{1}".format(object.__class__.__name__, object),
    ]
...
def object_detail(object,
    ...
    for field in m2m_fields:
        result += '\t' + field + '\t' + ', '.join(
            ['{}'.format(o) for o in getattr(object, field).all()]) + '\n'
